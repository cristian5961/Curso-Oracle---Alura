...
if (edad >= 18){
    console.log('Eres una persona myor de edad.');
} else {
...
//10-Crea una variable "nota" y asígnale un valor numérico. Utiliza un if-else para determinar si la nota es mayor o igual a 7 y 
